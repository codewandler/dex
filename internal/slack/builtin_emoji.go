...
// builtinEmojiNames contains all standard Unicode emoji short names supported by Slack.
//
// Source: https://github.com/iamcal/emoji-data (MIT license)
// Generated from emoji.json — do not edit manually.
//
// To regenerate after a new Emoji version is released:
//
//	curl -s https://raw.githubusercontent.com/iamcal/emoji-data/master/emoji.json | \
//	  python3 -c "
//	import json, sys
//	data = json.load(sys.stdin)
//	names = sorted({n for e in data for n in e.get('short_names', [])})
//	print('package slack\n')
//	print('// builtinEmojiNames contains ...')
//	print('var builtinEmojiNames = []string{')
//	for n in names: print(f'\t\"{n}\",')
//	print('}')
//	" > internal/slack/builtin_emoji.go
//
// Current data covers Emoji 16.0 (Oct 2024), 1972 short names across 1911 entries.

// BuiltinEmojiNames returns the list of built-in Unicode emoji short names supported by Slack.
func BuiltinEmojiNames() []string {
	return builtinEmojiNames
}

var builtinEmojiNames = []string{
	"+1",
	"-1",
	"100",
	"1234",
